                ...
                <tr>
                    <td bgcolor="#333333">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 30px 40px 30px 40px; text-align: center;"> <span style="color:#fff; font-size: 30px">Calendar</span> </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td background="https://i.pinimg.com/736x/07/e3/89/07e389f224911d80d1a5ca78ec2dd726.jpg" bgColor="#091a61" align="center" valign="top" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                        <div>
                                        ...
                                        <table>
                                            <tr>
                                                <td valign="top" style="text-align: center; padding: 60px 0 10px 20px;">
                                                    <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #ffffff; font-weight: bold;">BONJOUR {!! $body !!},</h1>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" style="text-align: center; padding: 10px 20px 15px 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #fff;">
                                                    <p style="margin: 0;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, quo exercitationem fugiat nulla laudantium harum recusandae impedit cupiditate aspernatur aliquam aut, id soluta quae aperiam nisi animi earum accusamus odit!</p>
                                                </td>
                                            </tr>
                                            <tr>
